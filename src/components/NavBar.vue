...
// const userId = JSON.parse(localStorage.user).sub;
// console.log(userId.value, 'user Data Id')
// const {
//     result: userResult,
//     loading: userLoading,
//     error: userError,
//     refetch: refetchUser
// } = useQuery(get_user_data.query, { user_id: "auth0|621a7c21bd0da500694f1490" }

// )
// console.log(userResult.value, 'this isi user result')
...
const settingProfile = () => {
    if (localStorage.user) {
        ...
        console.log(userData.value.sub, 'this is user data from setting profile')
